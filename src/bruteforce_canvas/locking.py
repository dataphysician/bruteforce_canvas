...
def build_default_lock_config(document: PromptDocument) -> LockConfiguration:
    entries: list[LockConfigEntry] = []
    ...
    return LockConfiguration(prompt_document_id=document.prompt_document_id, entries=entries)
